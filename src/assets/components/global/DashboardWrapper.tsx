    ...
    <>
      <div>
        ...
        <div
          ...
          } lg:block hidden w-64 z-50 bg-gray-700 fixed top-0 left-0 m-0 h-screen shadow-lg border-r-2 px-4 mx-auto border-primaryColor`}
        >
        ...
        >
          ...
          <div className="flex justify-center items-center gap-3">
            ...
            <div className="lg:hidden block w-10 mr-2"> Hmburger</div>
          </div>
        </div>
