...
import { dropDownVariant } from "../../utils/variants.tsx";
...
export const Library = () => {
  ...
  // for mobile
  const categoryClick = (direction: "left" | "right") => {
    if (scrollRef.current) {
  ...
  return (
    <div className="w-full max-w-full h-screen ">
      <Navbar />
      <div className="flex  h-full w-full mx-auto max-w-7xl relative ">
        {/* Main library body */}
        <div className="md:w-full md:pr-2 lg:w-8/12 overflow-y-auto slider relative">
          {/*-------------------------------------------------------------------------------------------------------------------------------------------------*/}
          {/*---------- Desktop search and category-----------------*/}
          <div className=" hidden  sticky top-0 z-[2] py-4  w-full items-center md:flex justify-start pl-1 md:pl-8 lg:pl-0 bg-white  gap-8">
            {/* Category section */}
            <div
            ...
            {/* Search section */}
            <div className="flex items-center border-2 px-2 rounded-lg h-10 w-[29rem] text-[rgba(0,0,0,0.5)]">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
          ...
          {is_word ? (
            ...
            <div
              className={
                "bg-[rgba(0,0,0,0.07)] gap-3 items-center p-2 rounded-lg grid grid-cols-4 content-start"
              }
            >
                ...
                >
                  ...
                  {hoveredBookId === book.id && (
                    ...
                    >
                      ...
                      <p
                        className={
                          "w-[2.5rem] cursor-pointer bg-default_secondary flex justify-center items-center text-xl text-white p-1.5 rounded"
                        }
                      >
                        <BsCart3 />
                      </p>
                  ...
                  <div
                    className={
                      "h-[14.5rem]  relative mx-1 mt-1 mb-0 rounded overflow-hidden"
                    }
                  >
                    {likeAnimations[book.id] && (
                      <div
                        className={
                          "heart absolute top-[50%] left-[50%] is-active h-[3rem] w-[3rem]"
                        }
                      ></div>
                    )}
                    ...
                    <img
                      alt={""}
                      className={
                        "w-full h-full object-cover object-top bg-cover"
                      }
                      src={book.img}
                    />
                  </div>
                  {/* Details section */}
                  <div
                    className={"h-fit items-center  flex flex-wrap mx-2  my-1"}
                  >
                    {/* Title and like button */}
                    <div
                      className={
                        "w-full items-center gap-1 flex justify-between"
                      }
                    >
                      <div
                        className={
                          "flex items-center flex-wrap gap-1 text-sm font-semibold w-full truncate"
                        }
                      >
                        <p className={"w-full truncate"}>{book.title}</p>
                        <p className={"w-full text-xs font-medium truncate"}>
                          {book.author}
                        </p>
                      </div>
                      <div
                    ...
                    <div
                      className={
                        " border-t pt-2 flex h-full justify-between items-center w-full"
                      }
                    >
                      <div
                        className={
                          "flex items-center gap-2 text-[gray] justify-evenly"
                        }
                      >
                      ...
                      <div
                        className={
                          "rounded cursor-default gap-0.5 text-[gray] font-medium text-xs"
                        }
                      >
                        {book.status === "private" ? (
                          <div
                            className={
                              "flex items-center h-3   gap-0.5 justify-between"
                            }
                          >
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
        ...
        <div
          className={
            "hidden lg:block w-4/12  pl-2 md:pr-8 lg:pr-0 overflow-y-auto"
          }
        >
          <AuthorsCard />
        </div>
          ...
          {openCategory && (
            ...
            >
              <motion.div
                ...
                exit="exit"
                onClick={handleClickInsideModal}
                className=" w-[16rem]  bg-white h-[25rem] border-2 mt-[8rem] drop-shadow-md flex flex-col justify-between rounded-lg"
              >
                {/* Scroll up */}
                {!atTop && (
                  <div
                    ...
                    className={
                      "flex items-center cursor-n-resize justify-center w-full h-8 border-b border-b-[rgba(0,0,0,0.05)] "
                    }
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                ...
                {!atBottom && (
                  <div
                    ...
                    onScroll={() => checkScrollPosition()}
                    className={
                      "flex items-center cursor-s-resize justify-center w-full  h-8 border-t border-t-[rgba(0,0,0,0.05)] "
                    }
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
