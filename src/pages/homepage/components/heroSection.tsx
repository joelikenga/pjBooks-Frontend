            ...
            <div className="max-w-full w-full ">
                <div className="w-full px-auto  md:px-6 m-0 h-[20rem] md:h-[35rem] flex justify-between items-center">
                    ...
                    <div className="relative w-full md:w-2/4  md:overflow-hidden  h-full flex items-center justify-end">
                        <div
                            ...
                            <div
                                ...
                                <div className="w-full flex justify-end items-center">
                                    <Link to={"/library"}
                                        className=" bg-default_secondary text-white px-4 py-2 rounded-lg text-md font-semibold">
                                        Explore
                                    </Link>
                                </div>
                            </div>
                        ...
                        <div
                            className=" w-[38rem] h-[38rem] overflow-hidden rounded-lg md:rounded-2xl flex flex-nowrap justify-between items-center ">
                            {/* animate card 1 */}
