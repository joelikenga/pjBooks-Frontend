...
export const NewBooks = () => {
  ...
  return (
    ...
    viewport={{"once" : true}}
    className="snap-y snap-mandatory py-4 md:px-6 w-full h-fit md:my-0">
          ...
          >
            ...
            {books.slice(0, 12).map((book) => (
              <motion.div
                ...
                className={
                  "overflow-hidden snap-x snap-mandatory h-[19.5rem] bg-white min-w-[12rem] rounded-md relative font-medium z-0 capitalize hover:"
                }
              >
                {/* price Description */}
