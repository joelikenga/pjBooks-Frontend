                ...
                <div
                    ...
                    <div className="w-full py-2 md:w-[18rem] flex content-start justify-start items-start flex-wrap  ">
                        ...
                        <div className="flex flex-nowrap justify-around mt-2 w-full items-center text-lg">
                            ...
                            <div className="w-1/5">
                                <a href="#"
                                   className=" h-[2rem] text-white w-[2rem] items-center justify-center rounded-sm flex bg-[yellow]"><GrSnapchat
                                    className=""/></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="w-full p-2 md:w-1/4 flex justify-start content-start items-center flex-wrap  ">
                        <div className=" p-1 md:text-lg font-semibold w-full flex items-center gap-1">
                            <p>Categories</p></div>
                    ...
                    <div className="w-full p-2 md:w-1/4 flex justify-start content-start items-start flex-wrap  ">
                        <div className=" p-1 md:text-lg font-semibold w-full flex items-center gap-1"><p>Help</p></div>
                        <a href="#" className="font-medium hover:underline p-1 md:text-base w-full">Privacy &
                            Policies</a>
                    ...
                    <div className="w-full p-2 md:w-1/4 flex justify-start content-start items-start flex-wrap  ">
                        ...
                        <a href="#" className="font-medium hover:underline p-1 md:text-base w-full">200 Salamis Road
                            99450</a>
                    </div>
                </div>
            </div>
