  ...
  return (
    <nav className=" sticky top-0 z-20 bg-white h-[3.5rem] md:h-[4rem] px-4 md:px-6 py-4 border-b border-default_primary_2  max-w-full w-full">
      ...
      >
        ...
        {/* ---------------------MobilesideNav ------------------------*/}
        {openSidenav && (
          <div onClick={()=>SetOpenSidenav(false)} className="md:hidden absolute z-[2] bg-[rgba(0,0,0,.5)]  flex justify-end h-screen w-full top-0 left-0">
              <div className="h-full bg-white w-[15rem] pt-[3.5rem] border border-[red]">
